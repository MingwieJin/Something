 (function(win,doc,undefined){
 	var zturn=function(turn){
 		...
 		this.zturnPy=turn.Awidth/(this.num_li-1+2)  
 		this.init()
 		this.turn_()
 		return this
 	}
...
//							})
							if(i==0){
								$(this).removeClass("pro_mouse_over zindex4R zindex3R zindex3L zindex4L")
								$(this).addClass("pro_mouse_over zindex5")
							}
							else if(i==1 && rt==1){
								$(this).removeClass("pro_mouse_over zindex5 zindex3R zindex3L zindex4L")
								$(this).addClass("zindex4R")
							}
							else if(i==2 && rt==1){
								$(this).removeClass("pro_mouse_over zindex4R zindex5 zindex3L zindex4L")
								$(this).addClass("zindex3R")
							}
							else if(i==2 && rt==-1){
								$(this).removeClass("pro_mouse_over zindex4R zindex3R zindex5 zindex4L")
								$(this).addClass("zindex3L")
							}
							else if(i==1 && rt==-1){
								$(this).removeClass("pro_mouse_over zindex4R zindex3R zindex3L zindex5")
								$(this).addClass("zindex4L")
							}
							else{$(this).removeClass("pro_mouse_over zindex4R zindex3R zindex3L zindex4L zindex5")}
