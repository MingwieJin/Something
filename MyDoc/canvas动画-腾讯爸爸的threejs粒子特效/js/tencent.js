...
"undefined" != typeof NotifyMe && (NotifyMe.myAlert = function(e) {
	console.log(e), alert(0 === e.n ? "鎮ㄥ凡棰勭害锛屼笉闇€瑕佸啀娆￠绾︼紒" : 1 === e.n ? "宸叉垚鍔熼绾P2017鐩存挱锛屾垜浠細鍦ㄧ洿鎾紑濮嬪墠閫氳繃QQ娑堟伅鎻愰啋鎮ㄨ鐪嬶紒" : 2 === e.n ? "寰堟姳姝夛紝鍙兘鏄郴缁熺箒蹇欙紝璇风◢鍚庡啀璇曪紒" : "鍙兘涓嶅湪娲诲姩鏃堕棿锛岃绋嶅悗鍐嶈瘯:" + e.n)
...
$(window).on("resize orientationchange", adjustSize), adjustSize(), /iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? (tryPgvSendClick({
	...
	$(".loadingwrapper").show()
}, 1e3), document.title = "UP2017鑵捐浜掑ū骞村害鍙戝竷浼�") : tryPgvSendClick({
...
}), $.getScript("//game.gtimg.cn/images/up/act/a20170301pre/js/pkg/webgl_ea9cb39.js", function() {}), $("body").addClass("webglyes")) : (tryPgvSendClick(ismobile ? {
