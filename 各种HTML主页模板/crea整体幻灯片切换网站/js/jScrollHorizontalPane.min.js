			...
			//if (1) {
				...
				if (settings.showArrows) {
					...
					if (settings.arrowSize) {
						trackWidth = paneWidth - settings.arrowSize - settings.arrowSize - settings.skip;
						$track
						...
						trackWidth = paneWidth - settings.skip - leftArrowWidth - jQuery('>.jScrollArrowRight', $container).width();
						$track
